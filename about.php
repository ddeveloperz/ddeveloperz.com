            ...
            <div class="container element_from_bottom">
                ...
                <div class="row text-center team-group">
                    ...
                    <div class="col-xs-6 col-md-3">
                        ...
                        <i>Social Media &amp; Marketing Manager</i>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <img src="images/rustam3.jpg">
                        <strong>Rustamveer Singh</strong>
                        <i>DBA, Security & System Engineer</i>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <img src="images/hardeep.jpg">
                        <strong>Manpreet Singh</strong>
                    ...
                    <div class="row element_from_bottom">
                        <div class="col-lg-12 text-center ddz-testimonials-wrapper">
                            ...
                            <ul class="ddz-testimonials">
                                ...
                                <li>
                                    <p>
                                        "Working with Ddeveloperz team has been a pleasure. They have consistently delivered excellent work quality and even contributed to the project with ideas that we have implemented! Highly recommended and we would definitely use again."
